...
export default {
  ...
  data: function() {
    return {
      requested_by: "",
      date: "",
      duration: new Date(new Date().setHours(1, 30, 0, 0)).toJSON(),
      location: "",
      notes: "",
      language: "",
      committee: "",
  ...
  computed: {
    languages: function() {
      return this.$store.state.courses.languages;
    },
    committees: function() {
      return this.$store.state.courses.committees;
    },
    filled: function() {
      return this.requested_by !== "" && this.committee !== "";
    }
  },
  created() {
